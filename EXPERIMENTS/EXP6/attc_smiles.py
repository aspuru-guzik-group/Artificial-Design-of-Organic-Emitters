    ...
    for i,smi_ in enumerate(filter_pass): 
        ...
        while fail_counter_ <= 5: 
            try: 
                ...
                print('Attaching: {}  {}'.format(val_cores[0], ligand_smiles_list))
                atached = smiles_functionalization(val_cores[0], ligand_smiles_list)
                if '.' in atached: 
                ...
                combined_origina_map[atached] = [smi_, smi_point_attc, val_cores[0]] # THe 
                fail_counter_ += 1
            except: 
                fail_counter_ += 1
