...
def substructure_violations(mol):
    ...
    """
    violation = False
    forbidden_fragments = ['[*+]', '[*-]', '[PH]', '[pH]', 'C(=O)-S', '*~C(=O)-F', '[O,o,S,s,N,n;!R]-,:[C,c;!R]=,:[C,c]', '[C;!R]=,:[N;!R]', '[C&H0;!R]=,:[C&H2;!R]','[C;R]=,:[C&H2;!R]', '[*;R]=,:[*;!R]-,:[*;!R]=,:[*;!R]', '[N&X5]', '*=[S,s;!R]', '[S&X3]', '[S&X4]', '[S&X5]', '[S&X6]', '[P,p]', '[B,b,N,n,O,o,S,s]~[F,Cl,Br,I]', '[*;!R]=,:[*;!R]-,:[*;!R]=,:[*;!R]',  '[Cl,Br,I]', '*=*=*', '*#*', '[O,o,S,s]~[O,o,S,s]', '[N,n,O,o,S,s]~[N,n,O,o,S,s]~[N,n,O,o,S,s]', '[C,c]~N=,:[O,o,S,s;!R]', '[N,n,O,o,S,s]~[N,n,O,o,S,s]~[C,c]=,:[O,o,S,s,N,n;!R]', '*=[NH]', '*=N-[*;!R]', '*~[N,n,O,o,S,s]-[N,n,O,o,S,s;!R]', '*-[CH1]-*', '*-[CH2]-*', '*-[CH3]']
